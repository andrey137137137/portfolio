...
const commentMapGetters = createNamespacedHelpers('comments').mapGetters;
const commentMapActions = createNamespacedHelpers('comments').mapActions;
...
export default {
  ...
  methods: {
    ...
    ...commentMapActions(['readComments']),
    handleSubmit() {
